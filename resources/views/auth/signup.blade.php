    ...
    <div class="w-full max-w-md">
        <div class="bg-white shadow-md rounded-lg px-8 py-8 pt-8">
            ...
            <form action="{{ route('signup') }}" method="POST">
                ...
                <div class="mb-4">
                    <button type="submit" class="w-full bg-green-900 text-white px-4 py-2 rounded-lg hover:bg-green-700">Sign Up</button>
                </div>
                <div class="text-center">
                    <p class="text-sm">Already have an account? <a href="{{ route('login') }}" class="text-green-900 font-bold">Sign In</a></p>
                </div>
            </form>
        </div>
    </div>
